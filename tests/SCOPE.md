...
| Create post            | done   | integration/create-post.spec.ts         | yes        | validation, upload/create/tag errors            | Draft posts, scheduled publishing                 |
...
| Profile                | done   | integration/profile.spec.ts             | yes        | contact edit, saved posts & offer, patch error  | Style preferences, metrics, avatar edit           |
...
| Received offers        | -      | —                                       | —          | —                                               | Out of scope this iteration                       |
