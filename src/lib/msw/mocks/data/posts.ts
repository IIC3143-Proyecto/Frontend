...
export const MOCK_SELLER_POSTS: PostDto[] = [
  ...
  { ...mockPost('post_2'), title: 'Levis 501 Custom', description: 'Talla M, usada dos veces.', priceClp: 18000, isNegotiable: false, status: PostStatus.PUBLISHED, offersCount: 2, imagesUrls: 'https://picsum.photos/seed/post2a/400/500' },
