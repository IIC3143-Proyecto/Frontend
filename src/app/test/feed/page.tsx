  ...
  return (
    <main className="flex-1 flex flex-row min-h-0">
      ...
      <div className="flex-1 flex flex-col min-h-0 min-w-0">
        ...
        <div className="flex-1 overflow-auto flex justify-center items-center gap-8 md:px-4">
          <IgnoreButton className="hidden md:flex" />

          <div className="relative h-full min-w-0 aspect-3/4 md:border-x">
        ...
        <div className="md:h-20 md:border-t flex items-center justify-center gap-6 my-6 md:my-0">
          <SaveButton />
      ...
      {isDesktopDetailsOpen && (
        <div className="w-1/3 hidden md:block border-l">
